...
const COPY = {
  ...
  en: {
    ...
    autoMergeReward: "Auto merge on for 5 min",
    noAdAutoMergeReward: "No ad found. Auto merge on for 5 min",
    woolOrder: "Order",
    shop: "Shop",
    quickBuy: "Quick buy",
    ...
    bought: (level, name) => `Lv.${level} ${name} bought`,
    ...
    noMerge: "Not enough matching sheep.",
    orderWait: (seconds) => `Ready in ${seconds}s`,
    rewardCoins: (reward) => `+${reward} coins`,
    adReward: "Ad reward: 5 min double income",
    noAdReward: "No ad available. 5 min boost added",
    ...
    resetConfirmText: "This clears local save, coins, sheep, and codes.",
    resetNow: "Restart",
    cancel: "Cancel",
    resetDone: "Data cleared. Fresh start.",
    questsTitle: "Daily Quests",
    questBuy: "Buy 8 sheep",
    questLv10: "Reach Lv.10",
    questNzd: "Earn NZD",
    currentLevel: (level) => `Lv.${level} now`,
    bookTitle: "Sheep Book",
    unknown: "Locked",
    mergeCount: (required) => `${required} to merge`,
    coinIncome: (amount) => `${amount} coins/s`,
    nzdIncome: (amount) => `${amount}/sec`,
    loginTitle: "Cloud Save",
    supabaseLocal: "Supabase not set. Local save on.",
    supabaseLocalPlay: "Supabase not set. Playing locally.",
    cloudInit: "Cloud save loading...",
    cloudHint: "Login to save to cloud.",
    ...
    redeemHint: "Enter a code to claim coins or sheep.",
    ...
    soundVolume: "SFX vol.",
    vibration: "Vibration",
    clearData: "Reset save",
    withdrawTitle: "Cash Out",
    balance: (amount) => `Balance ${amount}`,
    voucherNeed: (value) => `Need NZ$${value}`,
    voucherEmpty: "Voucher codes will show here.",
    ...
    bankMissing: "Fill in all bank details.",
    bankWithdrawSuccess: (value) => `Withdrawal submitted: NZ$${value}. Paid within 3 business days`,
    bankWithdrawHistoryTitle: "Withdrawals",
    bankWithdrawEmpty: "No withdrawals yet.",
    bankWithdrawRecord: (value, name, date) => `NZ$${value} · ${name} · ${date}`,
